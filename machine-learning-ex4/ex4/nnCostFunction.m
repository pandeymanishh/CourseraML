...
%reate a modified y vector with the configuration 5000*10
y1=1:num_labels==y;
xx=-y1.*log(a3)-(1-y1).*log(1.-a3);
J=(sum(sum(xx))/m);		   
%Get the regularized cost function
%It will be not be applicable for bias terms
